...
## Status
Interview-complete working requirements draft based on the user's answers.

## Confirmed Requirements
- The game is text driven.
- The setting is a Cairo slum and should use real Cairo districts and institutions rather than a fully fictionalized city.
- The protagonist should be selected from two preset identities: Amira, a young woman, or Karim, a young man.
- The protagonist should be in the 20-29 age range.
- The character must earn enough money to handle recurring survival needs such as rent and food.
- The player must face a major moral and economic choice between:
  - poorly paid but honest work
  - a life of crime
- The world should feel rich, reactive, and populated with many characters the player can interact with.
- The setting must include police presence.
- The setting must include shady competitors and other criminal rivals.

## Tonal Direction
- Tone: gritty and realistic.
- Realism target: mostly realistic, with some dramatic compression for playability and pacing.

## Core Experience Goals
- Present day-to-day survival pressure through money, hunger, health, stress, housing, and social risk.
- Make both honest and criminal choices feel meaningful, costly, and grounded in the setting.
- Build a strong sense of place through Cairo-specific people, language, routines, institutions, and local tensions.
- Populate the slum with recurring characters, factions, and consequences that change how the player is treated.
- Balance authored story beats with ongoing survival play.

## Structure and Progression
- The game structure should be a hybrid of survival simulation and authored story.
- The criminal route should have meaningful progression, but its consequences must remain strong and central.
- The game should support a few major endings rather than a single ending or an extremely large ending matrix.
- Long-term success should support multiple possible goals rather than a single fixed victory state.

## Required Gameplay Systems
- Money and recurring expenses
- Hunger or energy
- Health or injury
- Stress or morale
- Inventory
- Relationships and reputation
- Time of day or daily schedule
...
- Confirmed preset backgrounds:
  - dropout medical school student
  - released political prisoner
  - Sudanese refugee
- The protagonist begins with a widowed mother who depends on them.
- Family and household obligations should be important, but not constant in every scene.
- Romance should exist only as an optional minor subplot.
...
## Crime Path
- Crime should be a meaningful path with progression, but it must stay consequence-heavy.
- Confirmed criminal activities in scope:
  - stealing
  - robbery
  - selling hashish
- The world should enforce a strong no-snitching street code, especially around police contact and retaliation.
- Because explicit drug use depiction is out of bounds, narcotics should be handled through implication, trade, risk, and consequence rather than graphic or glamorized depiction.

## Factions and Recurring Characters
- The world should include organized local pressure from:
  - the Imbaba gang
  - Dokki thugs
  - ex-prisoner networks
- Recurring signature characters should include at least:
  - a landlord
  - a fixer
  - a police officer

## Writing and Language
- The writing should be in English with frequent transliterated Arabic.
- The Cairo setting should feel specific and lived-in rather than generic.
...
- Avoid torture and explicit police brutality detail.
...
- Composure reduces stress-caused work mistakes at level 2, eases loan-shark collection stress at levels 4 and 6, softens one-time community crisis relief at levels 6 and 8, and preserves two energy when a high-pressure work mistake is survived at level 8. It does not remove baseline stress or debt consequences.
...
At Provisioning 6, the home action **Preserve Food** converts two staple units into one preserved meal. It costs 60 minutes and 8 energy, is previewed before commitment, and is consumed before fresh staples when the player eats at home. Preserved meals provide a bounded food reserve for hot days and price shocks; the action does not create food or remove the cost of buying staples.
...
Three or more successful adaptation contributions plus two attended community events and Community Organizing 4 provide an alternate Network Shelter trajectory. The route still requires the existing day-30 and savings gates, so community organizing changes access without turning shelter into a free ending.

Technical Repair currently offers transparent repair-bench previews for a handset at Home (level 4, one part, 6 LE, 90 minutes), solar storage at the Workshop (level 6, two parts, 10 LE, 120 minutes), a rooftop water pump at the Workshop (level 6, two parts, 8 LE, 120 minutes), and a paid cooperative relay contract (level 8, two parts, 180 minutes). Handset, storage, and pump actions report current condition and bounded gains; level 6 technical repairs shorten the corresponding local infrastructure disruption by two days and storage recovery records cooperative maintenance debt. The contract remains available independently of storage condition and pays 35 LE, or 40 LE at level 10. Digital Literacy reduces phone-credit friction at levels 2 and 6, unlocks the Digital Dispatch Queue call-center variant at level 4, and offers a level-6 biometric appeal from Home. That appeal reports a 60/75/85 percent success chance at levels 6/8/10, always consumes time and money, and leaves an institutional review obligation pending.
...
- Unpaid loan shark debt triggers escalating events: threats (stress), visits (health damage), and eventually the **Destitution** ending if it reaches the critical collection state after 14 days overdue. Debt collapse does not create a separate ending identifier.
...
|--------------|---------------|-----------|----------|
| Successful crime (any) | "Something went missing near [location]" | 4-6 | District where crime occurred |
| Failed/detected crime | "People are asking questions" | 7-9 | District where crime occurred |
| Rent unpaid > 2 days | "The Mahfouz family is falling behind on rent again" | 3 | Home building (Imbaba) |
| Buying expensive item (cost > 50 LE) | "Where did that kind of money come from?" | 5-7 | District where purchase occurred |
| Seen in Dokki with criminal NPC | "They've been spending time with the Dokki crowd" | 6 | Cross-district (slow spread) |
| Taking mother to clinic 3+ times | "Always looking after that sick mother" | 3 (positive) | Home building |
| Skipping 3+ consecutive community events | "Too good for the neighborhood" | 4 | Home building |
| High district heat (> 60) | "Something is going on around here, and people are nervous" | 5 | District with high heat |
| Crime earnings > 200 LE total | "There's new money being flashed around" | 6 | Home district |
| Recent crime followed by a visible conversation with Officer Khalid | "Seen with the police" | 7 | District where the conversation happened |
