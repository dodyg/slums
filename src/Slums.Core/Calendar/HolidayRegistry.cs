...
public sealed class HolidayRegistry
{
    private static readonly IReadOnlyList<Holiday> Holidays = new List<Holiday>
    {
        new()
        {
            ...
            StartDate = new DateOnly(2031, 1, 7),
            DurationDays = 1,
        ...
        new()
        {
            ...
            Name = "Sham el-Nessim",
            StartDate = new DateOnly(2031, 4, 21),
            DurationDays = 1,
        ...
        new()
        {
            ...
            Name = "Ramadan",
            StartDate = new DateOnly(2031, 2, 28),
            DurationDays = 30,
        ...
        new()
        {
            ...
            Name = "Eid al-Fitr",
            StartDate = new DateOnly(2031, 3, 30),
            DurationDays = 3,
        ...
        new()
        {
            ...
            Name = "Eid al-Adha",
            StartDate = new DateOnly(2031, 6, 6),
            DurationDays = 4,
