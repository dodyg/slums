...
The patrol appears at the corner where the alley meets the main road. Two uniforms, a plainclothes officer, and a borrowed police quadcopter running an outdated recognition package. The officer watches faces with the patience of a man who has all day and no particular target. {gender == "male": The questions are casual until you notice they are asking who you walk home with. | The questions are casual until you notice the officer is deciding whether a woman alone after dark is a witness, a target, or an inconvenience.} Your pulse spikes. You have done nothing wrong today, but in Cairo, "nothing wrong" is not the same as "nothing to hide."
