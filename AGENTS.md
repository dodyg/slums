...
- After recompiling, refresh the committed freshness manifest with `cd content/ink && sha256sum *.ink > source-manifest.sha256`; `StoryArtifactValidationTests` rejects stale `.ink` sources against it
