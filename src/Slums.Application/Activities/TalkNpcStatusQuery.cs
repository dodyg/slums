...
#pragma warning restore CA1822
    ...
    private static string GetSummary(GameState gameState, NpcId npcId, NpcRelationship relationship)
    {
        ...
        return npcId switch
        {
            ...
            NpcId.RunnerYoussef when relationship.Trust >= 15 && gameState.CrimesCommitted >= 2 => "He talks to you like someone already half inside the route network.",
            NpcId.RunnerYoussef => "Quick, alert, and always half-turned toward the street.",
            NpcId.PharmacistMariam when gameState.Player.Household.MotherHealth < 40 => "She is likely to answer as a pharmacist first and a conversationalist second.",
            ...
            NpcId.LaundryOwnerIman when gameState.Player.Stats.Money < 50 => "She can read a lean week in the way you ask questions about cloth and cost.",
