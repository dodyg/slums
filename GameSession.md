...
| W2.3 | 2 | Community events & emergency support | In progress | Claim: extract community event availability, attendance, trust/background effects, and emergency support into `CommunityEventService`; preserve rolls, scene queues, and exact messages. |
