...
public sealed class InvestmentMenuQuery
{
    ...
    private static InvestmentMenuStatus BuildStatus(InvestmentMenuContext context, InvestmentDefinition definition)
    {
        ...
        return new InvestmentMenuStatus(
            ...
            InvestmentResolutionCalculator.GetExpectedWeeklyIncome(definition),
            (int)Math.Ceiling((double)definition.Cost / InvestmentResolutionCalculator.GetExpectedWeeklyIncome(definition)),
            definition.PerkDescription,
